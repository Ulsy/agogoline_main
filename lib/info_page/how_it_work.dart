...
class HowItDoesWork extends StatefulWidget {
  @override
  State<HowItDoesWork> createState() => _HowItDoesWork();
}

class _HowItDoesWork extends State<HowItDoesWork> {
                          ...
                          Container(
                            ...
                            child: Center(
                              child: Container(
                                width: 60,
                                height: 60,
                                child: Image.asset('web/icons/play.png',
