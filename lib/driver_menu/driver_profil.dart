...
import '../passenger_menu/update_profile.dart';

class DriverProfile extends StatefulWidget {
  @override
  State<DriverProfile> createState() => _DriverProfile();
}
...
class _DriverProfile extends State<DriverProfile> {
  ...
  void driverSetting() {
    Navigator.push(
      context,
      MaterialPageRoute(
          builder: (context) => DriverSettings(userData: _userConnected)),
    );
  }
